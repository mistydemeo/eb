 ...
 */
EB_Error_Code
eb_open_narrow_font_file(book, font_code)
    EB_Book *book;
 ...
 */
EB_Error_Code
eb_load_narrow_font_header(book, font_code)
    EB_Book *book;
    EB_Font_Code font_code;
{
    EB_Error_Code error_code;
     ...
     */
    if (zio_lseek(zio, (off_t)(narrow_font->page - 1) * EB_SIZE_PAGE, SEEK_SET)
	< 0) {
 ...
 */
EB_Error_Code
eb_load_narrow_font_glyphs(book, font_code)
    EB_Book *book;
    EB_Font_Code font_code;
{
    EB_Error_Code error_code;
 ...
 */
EB_Error_Code
eb_narrow_font_width2(font_code, width)
    EB_Font_Code font_code;
    int *width;
{
    EB_Error_Code error_code;
 ...
 */
EB_Error_Code
eb_narrow_font_size2(font_code, size)
    EB_Font_Code font_code;
    size_t *size;
{
    EB_Error_Code error_code;
