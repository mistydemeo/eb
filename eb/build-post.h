...
void eb_load_font_headers EB_P((EB_Book *));
...
/* narwfont.c */
EB_Error_Code eb_open_narrow_font_file EB_P((EB_Book *, EB_Font_Code));
EB_Error_Code eb_load_narrow_font_header EB_P((EB_Book *, EB_Font_Code));
EB_Error_Code eb_load_narrow_font_glyphs EB_P((EB_Book *, EB_Font_Code));
...
/* widefont.c */
EB_Error_Code eb_open_wide_font_file EB_P((EB_Book *, EB_Font_Code));
EB_Error_Code eb_load_wide_font_header EB_P((EB_Book *, EB_Font_Code));
EB_Error_Code eb_load_wide_font_glyphs EB_P((EB_Book *, EB_Font_Code));
